...
; source folder is passed in with /DVST3SRC=...  (it falls back to the local
; build tree so the script can also be test-compiled on Linux).
...
!ifndef VST3SRC
  !define VST3SRC "..\build\TekkChild670_artefacts\Release\VST3\TekkChild TC-670 Vari-Mu Compressor.vst3"
!endif
!ifndef VERSION
...
Section "TC-670 Plugin (VST3)" SecVST3
  ...
  SetOutPath "$COMMONFILES64\VST3\${VST3NAME}"
  File /r "${VST3SRC}/*.*"
